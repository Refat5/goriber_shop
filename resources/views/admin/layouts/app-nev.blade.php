 <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block">{{ __('customLanguage.Help')}} : +01305976639</li>
            <li class="nav-item dropdown language-dropdown">
              <a class="nav-link dropdown-toggle px-2 d-flex align-items-center" id="LanguageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <span class="profile-text font-weight-medium d-none d-md-block">{{ __('customLanguage.English')}}</span>
              </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img alt="image" height="30" src="{{Auth::user()->avater ? '/images/admin/'.Auth::user()->avater : 'profile.png'}}" class="rounded-circle mr-1">
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="{{Auth::user()->avater ? '/images/admin/'.Auth::user()->avater : 'profile.png'}}">
                  <p class="mb-1 mt-3 font-weight-semibold">{{ Auth::user()->name }} </p>
                  <p class="font-weight-light text-muted mb-0">{{ Auth::user()->email }} </p>
                </div>
                <a class="dropdown-item" href="{{route('admin.dashboard')}}">My Profile</a>
                                
                <a href="" class="dropdown-item">
                  <form class="form-inline" action="{{route('admin.logout')}}" method="post">
                    @csrf
                    <input type="submit" value="Log out" class="btn btn">
                  </form>
                </a>
